            ...
            <div class="row">
                <div class="col-xs-12">
                    ...
                    <div class="box box-info">
                        ...
                        <!-- /.box-header -->
                        <!-- form start -->
                        <form:form id="inputForm" cssClass="form-horizontal" action="/category/save" method="post" modelAttribute="tbContentCategory">
                            <form:hidden path="id" />
                            <div class="box-body">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input id="parentName" class="form-control" placeholder="请选择" readonly="true" data-toggle="modal" data-target="#modal-detail"  value="${tbContentCategory.parent.name}" />
                                    </div>
                                </div>
