package com.xianyuli.my.shop.commoms.utils;
...
public class MapperUtils {
     ...
     * 字符串转换为 Map<String, T>
     */
    public static <T extends Map<String, Object>> Map<String, T> json2map(String jsonString, Class<T> clazz) throws Exception {
