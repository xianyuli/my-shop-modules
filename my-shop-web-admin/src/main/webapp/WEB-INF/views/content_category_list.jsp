...
<head>
    ...
    <!--treeTable-->
    <link rel="stylesheet" href="/static/asserts/plugins/treeTable/themes/vsStyle/treeTable.css">
                            ...
                            <table id="treeTable" class="table table-hover">
                                ...
                                <c:forEach items="${tbContentCategories}" var="tbContentCategory">
                                    <tr id="${tbContentCategory.id}" pId="${tbContentCategory.parentId}">
                                       ...
                                       <td>
                                            <a href="/category/form?id=${tbContentCategory.id}" type="button" class="btn btn-sm btn-primary"><i class="fa fa-edit"></i> 编辑</a>&nbsp;&nbsp;&nbsp;
                                            ...
                                            <a href="/category/form?parent.id=${tbContentCategory.id}&parent.name=${tbContentCategory.name}" type="button" class="btn btn-sm btn-default"><i class="fa fa-plus"></i> 添加下级菜单</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<!--treeTable-->
<script src="/static/asserts/plugins/treeTable/jquery.treeTable.js"></script>
<script>
    $(function () {
        $("#treeTable").treeTable({
            expandLevel : 2,
