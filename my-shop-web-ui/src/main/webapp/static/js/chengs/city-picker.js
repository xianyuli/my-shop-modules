...
(function (factory) {
    if (typeof define === 'function' && define.amd) {
        ...
        define(['src/main/webapp/static/js/chengs/jquery', 'ChineseDistricts'], factory);
    } else if (typeof exports === 'object') {
        // Node / CommonJS
        factory(require('src/main/webapp/static/js/chengs/jquery'), require('ChineseDistricts'));
    } else {
        // Browser globals.
